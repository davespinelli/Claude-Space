...
gig = "https://www.fiverr.com/"  # TODO: replace with the live gig URL
...
<div class="cta"><strong>Want your own trading idea backtested?</strong> Rules in plain English → transparent Python backtest with costs, drawdowns and an honest verdict in 48h. <a href="{gig}">Order a backtest ($75–$200) →</a></div>
